...
args = {"server" : "http://0.0.0.0:3333", "user":"root@example.com","password": "test", "projectcode" : "0805", "ontoname" : "tdk_onto"}
...
with open("data") as csv_file:
    linecnt = 0
    for line in csv.reader(csv_file, dialect="excel", delimiter=';', quotechar='"'):
        linecnt = linecnt + 1
